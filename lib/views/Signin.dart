...
class _SigninState extends State<Signin> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      child:TextFormField(
                            controller: lemail,style: TextStyle(color: Colors.black ,fontFamily: 'Montserrat' ,fontSize: 20),
                            validator: (value) {
      ...
      child: TextFormField(
                            controller: lpass,style: TextStyle(color: Colors.black ,fontFamily: 'Montserrat' ,fontSize: 20),
