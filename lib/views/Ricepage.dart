...
import 'package:beta_eats/model/riceclass.dart';
...
class RicePage extends StatelessWidget {
  ...
  List<Rice> ricefoodies = Ricefood().foods;
  List<Rice> ricelist = Ricelist;
  ...
  Container AVfoodproperty(Rice food, int index, context) {
    return Container(
                ...
                children: [
                  Column(
                    children: [
                      ...
                      GestureDetector(
                          onTap: () {
                            if (Ricelist.contains(food)) {
                              Ricefood().removeFromCart(food);
                              ScaffoldMessenger.of(context)
                                  .showSnackBar(removesnack);
                            } else {
                            Ricefood().addToCart(food);
                              ScaffoldMessenger.of(context)
