...
import 'package:beta_eats/model/drinksclass.dart';
...
class DrinksPage extends StatelessWidget {
  ...
  List<Drinks> ricefoodies = Drinksfood().foods;
  List<Drinks> ricelist = Drinkslist;
  ...
  Container AVfoodproperty(Drinks food, int index, context) {
    return Container(
                ...
                children: [
                  Column(
                    children: [
                      ...
                      GestureDetector(
                          onTap: () {
                            if (Drinkslist.contains(food)) {
                              Drinksfood().removeFromCart(food);
                              ScaffoldMessenger.of(context)
                                  .showSnackBar(removesnack);
                            } else {
                            Drinksfood().addToCart(food);
                              ScaffoldMessenger.of(context)
